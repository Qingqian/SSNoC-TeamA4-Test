...
var private_history = $('#private_messages');
...
function displayPrivateMessages(source_private_messages, target_private_messages) {
	...
	private_message_blocks.sort(function(a,b) {return a.post_time-b.post_time});
	for(var i=0;i<private_message_blocks.length;i++) {
		...
		private_history.prepend(message_html);
	}
...
client_socket.on(source_user, function(message){
	...
	private_history.append(private_message_html);
});
